...
class ResearchTableRow extends Component {
    constructor(props) {
        super(props);
    ...
    approve(){
        axios.post('http://localhost:5000/reviewer/approveresearch/'+this.props.obj._id)
    ...
    reject(){
        axios.post('http://localhost:5000/reviewer/rejectresearch/'+this.props.obj._id)
            .then(this.setState({redirect: true}))
            .catch(err => console.log(err))
...
export default ResearchTableRow;